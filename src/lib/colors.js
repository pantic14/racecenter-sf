...
/**
 * VAM (m/h) color scale: grey at rest, greening as it climbs, orange around
 * pro-climb pace (~1600) and red beyond. Same interpolation as gradeColor.
 * @type {[number, [number, number, number]][]}
 */
const VAM_STOPS = [
  [0, [158, 158, 158]], // grey
  [800, [124, 179, 66]], // light green
  [1200, [69, 174, 81]], // green
  [1600, [255, 160, 0]], // orange
  [1900, [229, 57, 53]], // red
];

/**
 * Interpolated CSS color for a VAM value (m/h).
 * @param {number} v VAM in m/h
 * @returns {string} rgb() string
 */
export function vamColor(v) {
  const stops = VAM_STOPS;
